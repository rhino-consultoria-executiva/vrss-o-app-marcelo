...
-- Using anon role so the app can access without Supabase Auth
-----------------------------------------------------------
...
DROP POLICY IF EXISTS "Allow anon full access to leads" ON leads;
...
DROP POLICY IF EXISTS "Allow anon full access to service_orders" ON service_orders;
CREATE POLICY "Allow anon full access to service_orders"
ON service_orders FOR ALL TO anon USING (true) WITH CHECK (true);

-- Inventory table policies
DROP POLICY IF EXISTS "Allow logged-in users full access to inventory" ON inventory;
DROP POLICY IF EXISTS "Allow anon full access to inventory" ON inventory;
CREATE POLICY "Allow anon full access to inventory"
...
DROP POLICY IF EXISTS "Allow anon full access to funnel_stages" ON funnel_stages;
CREATE POLICY "Allow anon full access to funnel_stages"
ON funnel_stages FOR ALL TO anon USING (true) WITH CHECK (true);
